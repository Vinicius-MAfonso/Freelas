...
public class TaskEditDialogScreen extends javax.swing.JDialog {
    ...
    Task task;
    public TaskEditDialogScreen(java.awt.Frame parent, boolean modal, Task task) {
        super(parent, modal);
        this.task = task;
    ...
    private void initComponents() {
        ...
        jLabelTitle.setText("Editar tarefa");
        ...
        jLabelSave.setText("Editar tarefa");
    ...
    private void jLabelSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelSaveMouseClicked
        try{
            if(!jTextFieldName.getText().isEmpty() && !jFormattedTextFieldDeadLine.getText().isEmpty()){
                ...
                JOptionPane.showMessageDialog(jPanelContent, "Tarefa editada com sucesso!");
                dispose();
            }else{
    ...
    private void loadData(){
        ...
        try{
            SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
            Date deadLine = dateFormat.parse(task.getDeadLine().toString());
            jFormattedTextFieldDeadLine.setText(deadLine.toString());
        }catch(ParseException parseException){
            JOptionPane.showMessageDialog(jPanelContent, parseException.getMessage());
        }
